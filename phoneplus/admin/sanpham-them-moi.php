...
<head>
  ...
  <title>PHONEPLUS | Trang thêm mới sản phẩm</title>
                ...
                <form method="post" action="sanpham-them-moi-thuc-hien.php" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Giá bán<span
                        class="required">*</span></label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input name="txtGiaban" type="text" class="form-control">
                    </div>
                  </div>
                  <br>
                  <br>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <select name="txtDmsp">
                        ...
                        while ($row = mysqli_fetch_array($dulieu)) {
                          ; ?>
                          <option value="<?php echo $row["danh_muc_id"]; ?>"><?php echo $row["ten_danh_muc"]; ?></option>
                          <?php
                        }
                        ; ?>
                      </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <select name="txtKieusp">
                        ...
                        while ($row = mysqli_fetch_array($dulieu)) {
                          ; ?>
                          <option value="<?php echo $row["kieu_san_pham_id"]; ?>"><?php echo $row["kieu_san_pham"]; ?>
                          </option>
                          <?php
                        }
                        ; ?>
