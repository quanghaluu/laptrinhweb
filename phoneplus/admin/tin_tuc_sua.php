...
<head>
  ...
  <title>PHONEPLUS| Trang sửa tin tức</title>
                ...
                <form method="post" action="tin_tuc_sua_thuc_hien.php" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input name="txtTieuDe" type="text" class="form-control" value='<?php echo $row["tieu_de"]; ?>'>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input name="txtAnhMinhHoa" type="file" class="form-control"
                        value="/<?php echo $row['anh_minh_hoa']; ?>">
                    </div>
                  </div>
                  <br><br><br>
                  ...
                  <div>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <textarea name="txtNoiDung" class="form-control col-md-7 col-xs-12" id="txtNoiDung"
                        name="txtNoiDung"
                        placeholder="Nội dung chi tiết bài viết"><?php echo $row["noi_dung"]; ?></textarea>
                    </div>
                  </div>
                  <br><br><br><br>
