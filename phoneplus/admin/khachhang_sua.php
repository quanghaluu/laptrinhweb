...
<head>
  ...
  <title> PHONEPLUS| Trang sửa thông tin khách hàng </title>
          ...
          <div class="right_col" role="main">
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <form method="post" action="khachhang_sua_thuc_hien.php" enctype="multipart/form-data">

                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Tên khách hàng<span
                        class="required">*</span></label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input name="txtTen" type="text" class="form-control" value="<?php echo $row["tenkhach"]; ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Password<span
                        class="required">*</span></label>
                    <div class="col-md-9 col-sm-9 col-xs-12">
                      <input name="txtPassword" type="text" class="form-control" value="<?php echo $row["matkhau"]; ?>">
                    </div>
                  </div>
                  <br><br><br>
                  <div class="form-group" style="float: right;">
                    <input type="hidden" name="txtMakhach" value='<?php echo $row["makhach"]; ?>'>
