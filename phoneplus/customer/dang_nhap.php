...
<head>
  ...
  <title>PHONEPLUS |Trang đăng nhập </title>
      ...
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form method="post" action="dang_nhap_thuc_hien.php" onsubmit="return validateForm()">
            <br><br>
            <h1 style="color: white; text-shadow: black 0.1em 0.1em 0.2em"><b>Đăng nhập</b></h1>
            <div>
            ...
            <div>
              <scan style="color:black;">Bạn chưa có tài khoản? </scan> <b><a href="../customer/dangky.php">Đăng ký
                  ngay!</a></b>
            </div>
